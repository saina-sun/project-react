  ...
  inputRef.current.focus();
    ...
    return (
     ...
     <div style={{display:"flex"}}>
      <div  style={{ position: "relative"}}className={`mobileSideBar${isOpen ? "hide":""}`} onClick={toggleMenu}><img src="/photo/32.png" style={{ position: "absolute",left: "50%",transform: "translateX(-50%)"}}/><HoverableIcon style={{visibiliy:"hidden"}}tooltipText="Open sidebar"/></div>
       <Sidebar 
        isOpen={isOpen} 
         ...
         <div  className="main-inner">
            <div className="top-title" style={{display:"flex",justifyContent:"space-between", width:"100%"}}>
              <div  className="lipop chattext" style={{display:"flex"}}>
                ...
                <img src="/photo/inline-svg-20.svg" alt="SVG" className='mobile' style={{ width: "15px", height: "15px" }} />
    ...
    /></div>
            ...
            <div className="input-box" >
              <div className="plus"><img src="/photo/inline-svg-21.svg" alt="SVG" style={{margin:"10px"}}/><HoverableIcon style={{visibiliy:"hidden"}}tooltipText="Add files and more"/> </div>
            ...
            <input
              ...
              placeholder="Ask ChatGpt..." ></input>
                ...
                <div className="plus"><img src="/photo/inline-svg-22.svg" alt="SVG" style={{margin:"0px 20px",width:"20px",height:"auto"}} /><HoverableIcon style={{visibiliy:"hidden"}}tooltipText="Start dictation"/>
             </div>
            <div className="plus send-button"><img src="/photo/inline-svg-23.svg" alt="SVG" style={{margin:"20px"}}/><HoverableIcon style={{visibiliy:"hidden"}}tooltipText="send message"/> </div>
