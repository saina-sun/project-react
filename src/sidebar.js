     ...
     <div className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        <div className="sidebar-inner" style={{display: "flex", flexDirection: "column" }}>
          ...
          {/* <div style={{ display:"flex",justifyContent:"space-between",marginBottom:"-25px", marginTop:"0px" ,className:"sidebar-header"}}>
            <img src="/photo/inline-svg-7.svg" alt="SVG" className="close-btn"/>
            <div></div>
...
height:" 18px" , position:" absolute",left: "50%",transform:" translateX(-50%)"}}></img></li>
            ...
            <img  src="/photo/inline-svg-7.svg" alt="SVG" className="close-btn" onClick={toggleMenu}  />
            <div></div>
          </div ></li>
            <li className='mainli'> <img src="/photo/inline-svg-3.svg" alt="SVG"/> <span className="label">New chat</span></li>
            <li className={`mainli  ${isOpen ? "lipop":""}`} ><img src="/photo/inline-svg-4.svg" alt="SVG"/><span className="label">Search chats</span>
    ...
    /></div></li>
            <li className='mainli'><img src="/photo/inline-svg-5.svg" alt="SVG"/><span className="label">Images</span></li>
            <li className='mainli'><img src="/photo/6.png" /><span className="label">Plugins</span></li>
            <li className={`mainli  ${isOpen ? "lipop":""}`} ><img src="/photo/7.png" /><span className="label">Deep research</span>
             <div  className="popup-container"><Pop
    ...
    /></div></li>
          ...
          <div style={{marginTop:"auto", justifyContent:"flex-start" , borderTop: "1px solid #1A1A1A"}} >
            <ul >
            <li className='mainli'> <img src="/photo/inline-svg-15.svg" alt="SVG"/> <span className="label">See plans and princing</span><img className={`img${isOpen ?  "show":"hide"}`}src="/photo/12.png" style={{marginLeft: "auto"}}/></li>
            <li className='mainli'><img src="/photo/inline-svg-17.svg" alt="SVG"/><span className="label">Settings</span></li>
            <li className='mainli'><img src="/photo/inline-svg-18.svg" alt="SVG"/><span className="label">Help</span><img className={`img${isOpen ? "show":"hide"}`} src="/photo/12.png" style={{marginLeft: "auto"}}/></li>           
          </ul></div>
